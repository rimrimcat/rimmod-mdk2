...
public class ModCustomRegistries {
    ...
    public static final ResourceKey<Registry<AbstractSpecies>> PURE_CHEMICALS_REGISTRY_KEY = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(RimMod.MODID, "chemicals"));
    public static final Registry<AbstractSpecies> CHEMICAL_REGISTRY = new RegistryBuilder<>(PURE_CHEMICALS_REGISTRY_KEY)
            ...
            .defaultKey(ResourceLocation.fromNamespaceAndPath(RimMod.MODID, "air"))
